...
public class FrameMain extends javax.swing.JFrame {
    ...
    public class RecognizeThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                // Shows the found plate
                recognizedText = Main.systemLogic.recognize(this.parentFrame.car);
                this.parentFrame.platePanelContent = Photo.linearResizeBi(
                        Main.systemLogic.getPlate(),
                        this.parentFrame.platePanel.getWidth(),
                        this.parentFrame.platePanel.getHeight());
                this.parentFrame.platePanel.paint(this.parentFrame.platePanel.getGraphics());
            } catch (Exception ex) {
    ...
    BufferedImage platePanelContent;
    ...
    private void initComponents() {
        ...
        platePanel = // Added by Kyle Atkinson 2011.11.23
        // Show the plate that was found
        new JPanel() {
            public void paint(Graphics g) {
                super.paint(g);
                g.drawImage(platePanelContent,0,0,null);
            }
        };
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    .add(org.jdesktop.layout.GroupLayout.LEADING, bottomLine, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 587, Short.MAX_VALUE)
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    .add(platePanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .add(fileListScrollPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE)
                    .add(org.jdesktop.layout.GroupLayout.LEADING, recognitionLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE)
                    .add(recognizeButton, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE))
                .addContainerGap())
        );
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                        .add(fileListScrollPane, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 352, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(recognizeButton)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(platePanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
